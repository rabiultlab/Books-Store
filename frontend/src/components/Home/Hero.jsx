    ...
    return (
        <div className="h-[75vh] flex flex-col md:flex-row items-center justify-center">
            <div className="w-full mb-12 md:mb-0 lg:w-3/6 flex flex-col items-center lg:items-start justify-center ">
                ...
                <div className="mt-8">
                    <Link to="all-books" className="text-yellow-100 text-xl  lg:text-2xl font-semibold border border-y-red-100 px-10 py-3 hover:bg-zinc-800 rounded-full">Discover Books</Link>
                </div>
            </div>
